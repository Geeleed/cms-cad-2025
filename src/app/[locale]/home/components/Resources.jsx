      ...
      <div className="max-w-[1250px] w-full">
        <div>
          ...
          <div className="flex justify-center my-[20px]">
            <a className="text-(--d) underline" href={`/${locale}/resources`}>
              {`${dictionary.more_articles}...`}
            </a>
          </div>
        </div>
        <div>
...
const CardArticle = ({ title, detail, href = "#", dictionary }) => {
  return (
    <FadeInWrapper>
      <div className="card-article card">
        ...
        <div className="button mt-[20px]">
          <a href={href}>{`${dictionary.full_article}...`}</a>
          <div className="line" />
        </div>
      </div>
    </FadeInWrapper>
